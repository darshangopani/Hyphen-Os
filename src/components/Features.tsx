...
const features = [
  {
    ...
    icon: Search,
    colorClass: 'text-neon-blue border-neon-blue/30 shadow-[0_0_15px_rgba(0,243,255,0.3)]',
  },
  {
    id: 'proposal',
    ...
    icon: PenTool,
    colorClass: 'text-neon-purple border-neon-purple/30 shadow-[0_0_15px_rgba(188,19,254,0.3)]',
  },
  {
    id: 'escrow',
    ...
    icon: Lock,
    colorClass: 'text-terminal-green border-terminal-green/30 shadow-[0_0_15px_rgba(0,255,65,0.3)]',
  },
  {
    id: 'finance',
    ...
    icon: DollarSign,
    colorClass: 'text-slate-300 border-slate-300/30 shadow-[0_0_15px_rgba(203,213,225,0.3)]',
  },
];

export function Features() {
  return (
    <section className="relative min-h-screen flex flex-col justify-center py-32 px-4 bg-deep-space/80 backdrop-blur-md border-y border-white/5">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          {features.map((feature, index) => (
            ...
            >
              <div className="absolute inset-0 opacity-0 group-hover:opacity-20 transition-opacity duration-500 bg-gradient-to-br from-neon-blue via-transparent to-neon-purple" />
              ...
              <div className="relative z-10 flex flex-col h-full">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-2xl font-display font-bold tracking-wide text-slate-200">
                    {feature.title}
                  </h3>
                </div>
                
                <p className="text-slate-400 font-mono leading-relaxed flex-grow">
                  {feature.description}
                </p>

                <div className="mt-8 pt-6 border-t border-white/10 flex items-center justify-between text-xs font-mono text-slate-500">
